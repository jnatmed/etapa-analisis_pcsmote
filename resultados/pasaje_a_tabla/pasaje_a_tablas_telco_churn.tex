...
\begin{table}[ht]
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{tabular}{cllcccccc}
            \toprule
            \thead{Ranking} & \thead{Grado IF} & \thead{Técnica} & \thead{Sem. Val.*} & \thead{Sintet.} & \thead{Train Final\\(Orig + Sintet.)} & \thead{F1\_M Test} & \thead{F1\_W Test} & \thead{Acc Test} \\
            \midrule
            -- & -- & \textbf{Caso Base} & -- & -- & 5634 & 0,705 & 0,779 & 0,789 \\
            \midrule
            1 & \multirow{4}{*}{\shortstack{Grado 1 \\ (candidatas: \\ 1480)}} & \textbf{pcsmote (E1)} & \textbf{495} & \textbf{2617} & \textbf{8194} & \textbf{0,715} & \textbf{0,783} & \textbf{0,788} \\
            2 & & smote & -- & 2617 & 8194 & 0,713 & 0,776 & 0,776 \\
            3 & & adasyn & -- & 2535 & 8112 & 0,712 & 0,776 & 0,771 \\
            4 & & borderline & -- & 2617 & 8194 & 0,703 & 0,766 & 0,763 \\
            \midrule
            1 & \multirow{4}{*}{\shortstack{Grado 0 \\ (candidatas: \\ 1495)}} & smote & -- & 2644 & 8278 & 0,711 & 0,782 & 0,790 \\
            2 & & adasyn & -- & 2594 & 8228 & 0,710 & 0,773 & 0,771 \\
            3 & & \textbf{pcsmote (E2)} & \textbf{897} & \textbf{2644} & \textbf{8278} & \textbf{0,708} & \textbf{0,775} & \textbf{0,778} \\
            4 & & borderline & -- & 2644 & 8278 & 0,708 & 0,770 & 0,768 \\
            \bottomrule
        \end{tabular}
        \vspace{1mm}
        \begin{flushleft}
            \footnotesize * Semillas candidatas validadas en train. Nota: Las técnicas están ordenadas por F1\_M Test dentro de cada bloque de filtrado para mostrar el ranking real de pcsmote.
        \end{flushleft}
    \end{minipage}
\end{table}

...
\begin{table}[ht]
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{tabular}{cclcccccc}
            \toprule
            \thead{Ranking} & \thead{Umbral IF} & \thead{Técnica} & \thead{Sem. Val.*} & \thead{Sintet.} & \thead{Train Final\\(Orig + Sintet.)} & \thead{F1\_M Test} & \thead{F1\_W Test} & \thead{Acc Test} \\
            \midrule
            -- & \%0 & \textbf{Caso Base} & -- & -- & 5634 & 0,705 & 0,779 & 0,789 \\
            -- & \%1 & \textbf{Caso Base} & -- & -- & 5577 & 0,702 & 0,776 & 0,786 \\
            \midrule
            1 & \multirow{4}{*}{\shortstack{0\% \\ (candidatas: \\ 1495)}} & smote & -- & 2644 & 8278 & 0,711 & 0,782 & 0,790 \\
            ...
            \midrule
            1 & \multirow{4}{*}{\shortstack{1\% \\ (candidatas: \\ 1480)}} & \textbf{pcsmote (E1)} & \textbf{495} & \textbf{2617} & \textbf{8194} & \textbf{0,715} & \textbf{0,783} & \textbf{0,788} \\

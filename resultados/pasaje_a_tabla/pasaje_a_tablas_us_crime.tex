...
\begin{table}[ht]
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{tabular}{cllcccccc}
            \toprule
            \thead{Exp.} & \thead{Umbral IF} & \thead{Técnica} & \thead{Sem. Val.*} & \thead{Sintet.} & \thead{Train Final\\(Orig + Sintet.)} & \thead{F1\_M Test} & \thead{F1\_W Test} & \thead{Acc Test} \\
            \midrule
            -- & -- & \textbf{Caso Base} & -- & -- & 1595 & 0,765 & 0,940 & 0,945 \\
            \midrule
            \textbf{E1} & \multirow{4}{*}{\shortstack{0\% \\ (candidatas: \\ 120)}} & \textbf{pcsmote} & \textbf{21} & \textbf{1355} & \textbf{2950} & \textbf{0,801} & \textbf{0,948} & \textbf{0,952} \\
            -- & & adasyn & -- & 1368 & 2963 & 0,752 & 0,928 & 0,925 \\
            -- & & smote & -- & 1355 & 2950 & 0,736 & 0,923 & 0,920 \\
            -- & & borderline & -- & 1355 & 2950 & 0,725 & 0,923 & 0,922 \\
            \midrule
            \textbf{E2} & \multirow{3}{*}{\shortstack{1\% \\ (candidatas: \\ 118)}} & \textbf{pcsmote} & \textbf{2} & \textbf{1342} & \textbf{2920} & \textbf{0,788} & \textbf{0,944} & \textbf{0,947} \\
            -- & & borderline & -- & 1342 & 2920 & 0,719 & 0,918 & 0,915 \\
            -- & & smote & -- & 1342 & 2920 & 0,747 & 0,926 & 0,922 \\
            \midrule
            \textbf{E3} & \multirow{4}{*}{\shortstack{3\% \\ (candidatas: \\ 116)}} & \textbf{pcsmote} & \textbf{6} & \textbf{1314} & \textbf{2860} & \textbf{0,742} & \textbf{0,931} & \textbf{0,935} \\
